...
export const metadata: Metadata = {
  ...
  description: 'Read our Privacy Policy to understand how Quotifii collects, uses, and protects your personal information.',
  robots: 'index, follow',
}
        ...
        <div className="prose prose-lg max-w-none">
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                <span className="font-bold">You can opt out of receiving our marketing emails.</span> To stop receiving our promotional emails, email customer support at <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a> or follow the instructions in any promotional message you get from us. Even if you opt out of getting marketing messages, we will still send you transactional messages. These include responses to your questions. If you opt-out of receiving marketing communications from our business partners with whom we have shared your information, you will still receive marketing communications from us and any other business partners with whom your information was shared.
              </p>

              <p className="text-sm sm:text-base text-gray-700 leading-relaxed mt-4">
                <span className="font-bold">You can request that we stop sharing information with third parties for their marketing purposes.</span> To opt out of having us share your information with third parties for their promotional purposes, email us at <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>.
              </p>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                If you are a California resident, you have the right to (1) request more information about the categories and specific pieces of personal information we have collected, sold and disclosed for a business purpose in the last 12 months, (2) request deletion of your personal information, (3) opt out of the sale of your personal information, if applicable, and (4) be free from discrimination for exercising your rights under the CCPA. You may make these requests by emailing <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a> To opt out of sales, you can email <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>. We will verify your request by confirming at least two pieces of personal information, including contact information, you provided in submitting your form. To designate an authorized agent to exercise these rights on your behalf, send an email with your request to <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
              If you have any questions about this Policy, please email us at <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>.
              </p>
