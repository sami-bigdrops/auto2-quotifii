...
export const metadata: Metadata = {
  ...
  description: 'Read our Terms of Use to understand the rules and regulations for using Quotifii services.',
  robots: 'index, follow',
}
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed font-semibold mb-4">
                ...
                <p className="text-gray-700 leading-relaxed mt-4">
                    You may opt-out of this arbitration provision only by written notice to us at the Notice Address (<a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>) within thirty (30) days of your acceptance of this agreement, which notice shall include your name, address, and a clear statement that you do not wish to resolve disputes with us through arbitration.
                </p>
            ...
            <section>
              ...
              <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                When you use the Site, you consent to the collection and use of your personally identifiable information in accordance with the Quotifii <Link href="/privacy-policy" className="text-[#1E3A8A] hover:underline font-bold">Privacy Policy</Link>, which is incorporated into these Terms. Our Privacy Policy explains our information collection practices and safeguards, how we use and share your information, and how to opt-out of receiving communications from us.
              </p>
            </section>
            ...
            <section>
                ...
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">Except as explicitly stated otherwise, any notices sent from you to us shall be submitted via e-mail at <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>. When we need to send a notice to you, it shall be sent to the e-mail address you last provided to us. Notice shall be deemed given upon receipt or 24 hours after e-mail is sent, unless the sending party is notified that the e-mail address is invalid.</p>
            ...
            <section>
                ...
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">At any time, you can update the email address to which we will send alerts that Disclosures are available. You can change your email address by contacting us at: <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a></p>
            ...
            <section>
                <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-[#1E3A8A] mb-3 sm:mb-4">Contact Quotifii</h2>
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">If you have any questions regarding any of these Terms, please contact us by emailing <a href="mailto:contact@quotifii.com" className="text-[#1E3A8A] hover:underline font-medium">contact@quotifii.com</a>.</p>
